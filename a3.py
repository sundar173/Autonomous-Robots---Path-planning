...
class AStarSearch:
    ...
    def get_possible_moves(self):
        ...
        #   -Add to not explored list if valid and not explored.
            if str(move) not in self.not_explored and str(move) not in self.explored:
                ...
                # self.not_explored[str(move)] = self.pos_depth + 1 ###### BFS
    ...
    def goal_found(self):
        if self.goal_str in self.not_explored:
            ...
            # self.pos_depth = self.not_explored.pop(self.goal_str) ###### BFS
    ...
    def explore_next_move(self):
        ...
        # self.pos_depth = self.not_explored.pop(self.pos_str) ##### BFS
    ...
    def heuristic(self, move):
        distance  = goal - move
        answer = np.sqrt(np.sum(distance*distance))
